...
//For debuggging data returned
//console.log('data.response: ',data.response);
//console.log('outputSpeech: ',data.response.outputSpeech);

        //var textToSay = data.response.outputSpeech.ssml;
        var textToSay = data.response.outputSpeech.text;
    ...
    var eventJSON =
        {
            "session": {
                ...
                "application": {
                    "applicationId": "amzn1.ask.skill.27e675ae-4a57-4877-9774-d7635062bb7a"
                },
                "attributes": sa,
                "user": {
